...
task main()
{
  ...
  while(true)
  {
   ...
   // else
    ...
    /*nxtDrawRect(0,0,20,y1);
    nxtDrawRect(20,0,40,y2);
    nxtDrawRect(40,0,60,y3);
    nxtDrawRect(60,0,80,y4);
    nxtDrawRect(80,0,100,y5);*/

    if(time100[T1]==1)
    {
      ClearTimer(T1);
      nxtDrawLine(n,0,n,y1);
      nxtDrawLine(20+n,0,20+n,y2);
      nxtDrawLine(40+n,0,40+n,y3);
      nxtDrawLine(60+n,0,60+n,y4);
      nxtDrawLine(80+n,0,80+n,y5);
      n++;
    }
